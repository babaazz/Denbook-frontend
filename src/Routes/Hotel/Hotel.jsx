...
const Hotel = () => {
  ...
  const handleMove = (direction) => {
    ...
    if (direction === "l") {
      newSlideNumber = slideIdx === 0 ? 5 : slideIdx - 1;
    } else {
      newSlideNumber = slideIdx === 5 ? 0 : slideIdx + 1;
    }

    setSlideIdx(newSlideNumber);
  };
    ...
    <div className="hotel">
      {openSlide && (
        <div className="slider">
          <IoClose onClick={() => setOpenSlide(false)} className="close" />
          <FaArrowCircleLeft
